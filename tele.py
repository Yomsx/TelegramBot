...
def generate_response(inputs):
    ...
    response = llm.predict(prompt_template.format(message=user_message, history=conversation_history))
    memory.save_context({"message": user_message}, {"response": response})  # Save conversation in memory
